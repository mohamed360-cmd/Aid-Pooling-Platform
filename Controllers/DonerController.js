...
const addDonation = async(req,res)=>{
    ...
    if(userVerfier.status){
        if(userVerfier.data.userRole === "DONER"){
            ...
            var sqlStatement = 'INSERT INTO  donations (Doner_Id,Doner_Email,Doner_Phonenumber,Donation_Type,Donation_Description,Donation_Amount, Expiration_Date,Dontaion_Pickup_Location,Donation_Availability) VALUES(?,?,?,?,?,?,?,?,?)'
            var params = [doner_Details[0].id,doner_Details[0].Organization_Email, doner_Details[0].Organization_PhoneNumber, req.body.donationType, req.body.donationDescription,req.body.quantity,req.body.expiryDate,req.body.location,true]
...
module.exports = {getAddDonation,addDonation}